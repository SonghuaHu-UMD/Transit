...
dat <-
  read.csv('D:\\Transit\\Daily_Lstaion_Final.csv') # Daily_Lstaion_Final_0806.csv
...
finalMatrix <-
  foreach(
    ...
    first_enforce_day <- as.numeric(rownames(dat_Each[dat_Each$date == as.Date('2019-01-01'),]))
...
stopCluster(cl)
write.csv(finalMatrix, 'finalMatrix_Transit_2019.csv')
